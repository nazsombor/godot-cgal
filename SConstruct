...
opts.Add(PathVariable("target_path", "The path where the lib is installed.", "demo/gdnative/"))
opts.Add(PathVariable("target_name", "The library name.", "libcgal", PathVariable.PathAccept))
